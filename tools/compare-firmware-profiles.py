...
OPTIONAL_SOURCES = {
    ...
    "components/zectrix_demo_ui/zectrix_micro_app_ui.cc",
    "components/zectrix_demo_ui/zectrix_micro_app_view.cc",
    "components/zectrix_app/zectrix_usb_manager.cc",
    "components/zectrix_demo_ui/zectrix_usb_manager_ui.cc",
